...
namespace offsets {
    ...
    inline constexpr uintptr_t ParticleRotation = 0x214;
    inline constexpr uintptr_t PartSize = 0x1b8;
    inline constexpr uintptr_t Pavement = 0x42;
    inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x74da5ec;
    ...
    inline constexpr uintptr_t PlatformStatePointer = 0x5fa8860c;
    ...
    inline constexpr uintptr_t PrimitiveOwner = 0x200;
    ...
    inline constexpr uintptr_t SpawnLocationAllowTeamChangeOnTouch = 0x1f8;
